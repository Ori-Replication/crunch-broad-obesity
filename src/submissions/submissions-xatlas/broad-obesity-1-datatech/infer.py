...
预测表由 prepare_resources.py 使用 PCA_HEK_pc5_alpha100 方法生成：
- 对竞赛训练 delta 做 PCA（5 个主成分）
- 对 xatlas HEK293T delta 做 PCA（30 个主成分）
- Ridge 回归（alpha=100）从 xatlas PCA -> 竞赛 PC scores
- 不在 xatlas 中的扰动回退到 PerturbMean
"""
